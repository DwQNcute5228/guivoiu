...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi em bé sẽ là của anh!";
    let charArrTitle = textTitle.split('');
let text = "Đây là lần đầu tiên anh làm điều này, cách tỏ tình này lạ bé nhỉ:3?, bé ơi, trong khoảng thời gian chúng mình tìm hiểu lại nhau, anh càng thấy thương em rất nhiều, chẳng vì lí do gì cả, đơn giản em là một phần quan trọng trong anh thui nè, em đồng ý làm người yêu anh chứ, anh mong chuyện tình này sẽ thật là lâu dài cho cả 2 đứa mình và có kết thúc bằng một cái đám cưới thật lộng lẫy. Làm Người Yêu Anh Nhé Baby, nhắn cho anh nhé, những mùa giáng sinh của các năm sau, con tim đôi mình đều được sưởi ấm bởi tình cảm của nhau!Anh yêu em...... Chúc mừng giáng sinh 2 chúng mình, chúc chúng mình mãi là của nhau và ở lại bên nhau, anh mong món quà nho nhỏ này sẽ làm em thích và vui:3"
